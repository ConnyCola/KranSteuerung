...
//*******************************//
#define VERSION "7.0"		//Version der Steuerung
...
int ainOLD[] = {1020,1020,1020,1020,1020,1020};						//Array for OLD analog Values
...
void setup(void) {
	...
	//Init TFT Display
	delay(700); //delay for Display fail
	tftINIT();
